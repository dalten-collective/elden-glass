...
<CalloutRow cols={3}>
  <ConceptCard icon="circle" accent="gold" title="Closed Systems">
    Bachelor machines operate as sealed loops, producing energy that fuels their own operation
    indefinitely.
  </ConceptCard>
  <ConceptCard icon="zap" accent="blue" title="Frustrated Desire">
    The machine's purpose is perpetual striving without fulfillment - desire that generates but
    never consummates.
  </ConceptCard>
  <ConceptCard icon="sparkles" accent="purple" title="Artistic Expression">
    Bachelor machines appear throughout 20th century art, representing modernity's alienation and
...
Michel Carrouges later expanded the concept in his 1954 book _Les Machines Celibataires_, identifying bachelor machines across literature and art: Kafka's penal colony apparatus, Raymond Roussel's impossible inventions, and Alfred Jarry's perpetual motion devices.
