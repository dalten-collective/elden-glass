...
export const metadata: Metadata = {
  ...
  description:
    "A selection of direct quotes from Duchamp's notes describing the components and geometry of The Bride Stripped Bare by Her Bachelors, Even.",
};
    ...
    <div className="space-y-10">
      ...
      <section className="glass-card border border-[var(--border-emphasis)] bg-gradient-to-b from-[rgb(var(--bg-secondary-rgb)/0.9)] to-[rgb(var(--bg-secondary-rgb)/0.6)] p-8 lg:p-12">
        <div className="max-w-3xl">
          ...
          <h1 className="page-hero-title">Selected Quotes on the Large Glass</h1>
          <p className="page-hero-description">
            Direct quotes from Duchamp&apos;s notes describing the components and geometry of{' '}
      ...
      <section className="prose prose-lg prose-invert max-w-none">
        ...
        <p className="text-sm text-[var(--text-tertiary)] italic">
          Source: Roberto Giunti, &quot;The Bachelor Stripped Bare by Cabri Géomètre, Even&quot;
          (2007), citing Duchamp&apos;s notes.
        </p>

        <h3>Bachelor Apparatus (General Forms)</h3>
        <blockquote>
          <p>
            &quot;The principal forms of the bachelor apparatus or utensil are imperfect: Rectangle,
            circle, square, parallelepiped, symmetrical handle; demisphere.&quot;
          </p>
        </blockquote>
        ...
        <blockquote>
          <p>
            &quot;The wheels will rotate forward and backward, the paddles will be over and under,
            in front and back.&quot;
          </p>
        </blockquote>
        <blockquote>
          <p>
            &quot;The rotation of the water wheels was intended to enable the onanistic left-right
            motion of the Chariot.&quot;
          </p>
        </blockquote>
        ...
        <blockquote>
          <p>
            &quot;The spangles pass through the parasols A, C, D, E, F…B. and as they gradually
            arrive at D, E, F, … etc. they are straightened out.&quot;
          </p>
        </blockquote>
        <blockquote>
          <p>
            &quot;The group of these parasols forms a sort of labyrinth of the three
            directions.&quot;
          </p>
        </blockquote>
        ...
        <blockquote>
          <p>
            &quot;In the Bride – the principal forms will be more or less large or small, no longer
            have mensurability in relation to their destination.&quot;
          </p>
        </blockquote>
        <blockquote>
          <p>
            &quot;Parabolas, hyperbolas (or volumes deriving from them) will lose all connotation of
            men-surated position.&quot;
          </p>
        </blockquote>
