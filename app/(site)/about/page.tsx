    ...
    <div className="space-y-8">
      <Card>
        <CardHeader className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.35em] text-[var(--text-tertiary)]">About the author</p>
          ...
          <div className="flex items-center gap-3 text-[var(--text-secondary)]">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[var(--text-tertiary)]">Updated</p>
