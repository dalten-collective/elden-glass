...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive collection of scholarly articles about Duchamp's involvement with chess from Toutfait: The Marcel Duchamp Studies Online Journal",
};
    ...
    <div className="space-y-10">
      ...
      <section className="glass-card border border-[var(--border-emphasis)] bg-gradient-to-b from-[rgb(var(--bg-secondary-rgb)/0.9)] to-[rgb(var(--bg-secondary-rgb)/0.6)] p-8 lg:p-12">
        <div className="max-w-3xl">
          ...
          <h1 className="page-hero-title">Chess Research</h1>
          <p className="page-hero-description">
            Scholarly articles about Duchamp&apos;s chess career and its artistic significance from
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-[var(--text-secondary)]">
            This page collects scholarly articles from{' '}
            <a
            ...
            , the premier online journal for Marcel Duchamp studies. These articles explore
            Duchamp&apos;s profound engagement with chess—not as a hobby or diversion, but as an
            integral part of his artistic practice.
          </p>
          <p className="text-[var(--text-secondary)]">
            The research represented here reveals chess as central to understanding Duchamp&apos;s
            conceptual approach to art. From his influence on Samuel Beckett (Hugill) to the
            medieval chess moralities embedded in the Large Glass (Bailey), these articles
            demonstrate that Duchamp&apos;s &quot;abandonment&quot; of art for chess was itself an
            artistic statement.
          </p>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          {chessArticles.map((article, index) => (
            <Card
              key={index}
              className="group hover:shadow-lg transition-all border-[var(--border-subtle)] hover:border-[var(--accent-gold)]/30"
            >
              <CardHeader>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-[var(--text-secondary)]">
            <p>
              Duchamp didn&apos;t abandon art for chess—he pursued art through chess. The game
              embodied everything he valued: pure concept, combinatorial infinity, strategic depth,
              and beauty in the abstract.
            </p>
            <p>
              His 1932 book on chess endgames, <em>Opposition and Sister Squares Are Reconciled</em>
              , dealt with positions so rare they bordered on the &apos;pataphysical—the science of
              imaginary solutions.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-[var(--text-secondary)]">
            <p>
              Bailey&apos;s research reveals how medieval chess moralities—allegorical sermons using
              chess pieces to represent social classes—directly influenced the Nine Malic Molds in
              the Large Glass.
            </p>
            <p>
              The Bachelors function as pawns in Duchamp&apos;s &quot;great game,&quot; their
              uniforms serving as empty vessels just as medieval pawns served as symbolic containers
