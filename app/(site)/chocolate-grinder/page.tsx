...
export const metadata: Metadata = {
  ...
  description:
    'The Elden Ring symbol is the Chocolate Grinder from The Large Glass viewed from above',
};
    ...
    <div className="space-y-10">
      ...
      <section className="glass-card border border-[var(--border-emphasis)] bg-gradient-to-b from-[rgb(var(--bg-secondary-rgb)/0.9)] to-[rgb(var(--bg-secondary-rgb)/0.6)] p-8 lg:p-12">
        <div className="max-w-3xl">
          ...
          <h1 className="page-hero-title">The Chocolate Grinder</h1>
          <p className="page-hero-description">
            The Elden Ring symbol - the iconic image on every cover and loading screen - is
            Duchamp&apos;s Chocolate Grinder viewed from directly above.
          </p>
        </div>
        <HeroMeta
          items={[
      ...
      <section className="prose prose-lg prose-invert max-w-none">
        ...
        <p>
          ...
          Duchamp based it on an actual chocolate grinding machine he saw in a confectioner&apos;s
          window in Rouen, France. In The Large Glass, it represents the self-grinding,
          self-sufficient mechanism of bachelor desire.
        </p>
        <p>
          Duchamp famously said of it:{' '}
          <em>&quot;The bachelor grinds his chocolate himself.&quot;</em>
        ...
        <p>
          When you rotate Duchamp&apos;s Chocolate Grinder 90 degrees to view it from directly
          above, the iconic Elden Ring symbol emerges. The three cylindrical drums become the
          radiating segments. The central axis becomes the core ring. The supporting legs become the
          anchor points.
        </p>
        <p>
          This isn&apos;t coincidence or vague similarity - it&apos;s geometric correspondence. The
          Great Runes, which are fragments of the Elden Ring, map to specific parts of the Grinder
          mechanism.
        </p>
        ...
        <p>
          ...
          loading screen - is Duchamp&apos;s Chocolate Grinder, then the connection is not
          peripheral. It&apos;s foundational. The game is literally named after a component of The
          Large Glass.
        </p>
        <p>
          The Chocolate Grinder is where the Bachelors process their desire. The Elden Ring is where
          the Tarnished process theirs. Same mechanism, different medium.
        </p>
      </section>
