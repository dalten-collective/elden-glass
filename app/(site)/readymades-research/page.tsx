...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive collection of scholarly articles about Duchamp's readymades from Toutfait: The Marcel Duchamp Studies Online Journal",
};
...
const readymadesArticles: Article[] = [
  ...
  },
  {
    ...
    author:
      'Rhonda Roland Shearer (with Gregory Alvarez, Robert Slawinski, Vittorio Marchi, and Stephen Jay Gould)',
    date: 'December 1, 2000',
    ...
    <div className="space-y-10">
      ...
      <section className="glass-card border border-[var(--border-emphasis)] bg-gradient-to-b from-[rgb(var(--bg-secondary-rgb)/0.9)] to-[rgb(var(--bg-secondary-rgb)/0.6)] p-8 lg:p-12">
        <div className="max-w-3xl">
          ...
          <h1 className="page-hero-title">Readymades Research</h1>
          <p className="page-hero-description">
            Scholarly articles about Duchamp&apos;s readymades from Toutfait: The Marcel Duchamp
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-[var(--text-secondary)]">
            ...
            , the premier online journal for Marcel Duchamp studies. These articles explore various
            aspects of Duchamp&apos;s revolutionary readymades, from technical analysis to
            philosophical implications.
          </p>
          <p className="text-[var(--text-secondary)]">
            The research represented here ranges from challenging the basic assumption that
            readymades were unmodified found objects (Shearer, Obalk) to exploring their cultural
            and philosophical significance (Girst, O&apos;Halloran). This collection is essential
            reading for understanding the complexity beneath what appears to be a simple artistic
            gesture.
          </p>
        </CardContent>
      </Card>
