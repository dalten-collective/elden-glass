...
<DefinitionItem
  ...
  source={`(Bök 1997)`}
>
The Toronto Research Group and related Canadian 'pataphysicians work with memory and its failures. Their exceptions emerge from the corruption of archives, the degradation of texts, the fossilization of language. Where Futurists accelerate toward the future and Oulipians constrain the present, Canadians excavate the past,finding in its ruins not nostalgia but mutation. The Canadian swerve is the misremembering that creates something new from something old, the copy error that becomes more interesting than the original.
</DefinitionItem>
