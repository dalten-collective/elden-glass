...
This report mines Christian Bök's 1997 dissertation, *'Pataphysics: The Poetics of an Imaginary Science*, for definition-like passages relevant to the Elden Glass title-card system. The OCR is noisy, so the list below is an editorial audit aid rather than an automatically authoritative glossary.
